...
@click.option(
    ...
    type=click.Choice(["ddpmpp", "ncsnpp"]),
    default="ddpmpp",
    show_default=True,
)
@click.option(
    ...
    metavar="vp|ve|edm",
    type=click.Choice(["vp", "ve", "edm", "fdm_edm", "fdm_vp", "fdm_ve"]),
    default="fdm_edm",
    show_default=True,
)
...
@click.option(
    "--lr_rampup",
    help="Learning rate rampup",
    metavar="FLOAT",
    type=click.FloatRange(min=0, max=1000),
    default=10,
    show_default=True,
)
@click.option(
...
@click.option(
    "--warmup_ite",
    help="Loss weight warmup iteration",
    metavar="FLOAT",
    type=float,
    default=None,
    show_default=True,
...
@click.option(
    "--fdm_multiplier", help="FDM multiplier", metavar="FLOAT", type=float, default=2.0
)
